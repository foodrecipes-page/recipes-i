...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'i'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-i@main/recipes/<cuisine>/<diet>/<slug>.json
```
